...
public class IcicleSpawner1 : MonoBehaviour
{

    private Vector2[] spawnPosArray = {new Vector2(-4.5f, 4.5f), new Vector2(3.6f, 3.4f), new Vector2(-1.3f, 3.8f), new Vector2(0.1f, 3.7f), new Vector2(6.5f, 1.9f)};//生成位置の候補リスト
