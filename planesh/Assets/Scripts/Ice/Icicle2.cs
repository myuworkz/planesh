...
public class Icicle2 : StillAccelerator
{
    ...
    private void Awake()
    {
        ...
        //生成時、つららの生成位置番号にアクセス
        numIcicle = icicleSpawner.GetComponent<IcicleSpawner2>().latestIcicle;
    ...
    private void resetBall()
    {
        ...
        icicleSpawner.GetComponent<IcicleSpawner2>().setIcicleNumToList(numIcicle);
